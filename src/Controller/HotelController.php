...
class HotelController extends AbstractController
{
    ...
    /**
     * @Route("/hotel/list", name="get_hotel")
     */
    public function getHotelList()
    {
        ...
        $this->logger->info("RESPONSE RESULT:: ".var_export($response, true));
    ...
    /**
     * @Route("/hotel/detail", name="get_hotel_detail")
     */
    ...
    {  
        ...
        $logStep = 0;
        $tagName = 'get_hotel_detail(hotel_id='.$hotel_id.')';
        $logId = 'client_ip='.$request->getClientIp();
    ...
    public function getRoomList()
    {
        ...
        $logStep = 0;
        $tagName = 'get_room_list(trip_id='.$trip_id.')';
        $logId = 'client_ip='.$request->getClientIp();
